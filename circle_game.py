...
class Player:
    def init(self, color, x, y, radius):
        self.color = color
        self.x = x
        self.y = y
        self.radius = radius
    ...
    def getintersect(self, seg1_start, seg1_end, wall_vector):
    ...
    def playermove(self, p):
        ...
        for wall, collision_handler in wall_collisions:
            intersection_point = self.getintersect(p[-2], p[-1], wall)
